...
func (t *Telegram) handleAboutTheFundBtn(ctx telebot.Context) error {
	...
	return ctx.Send("Об инвестиционном фонде EMIVN\nИнвестиционный фонд EMIVN основан в 2019 году. С первых дней работы, основываясь на принципе открытости, фонд стал проводить публичные мероприятия. Деятельность фонда стала привлекательна для инвесторов за счет грамотной диверсификации инвестиций. Аудиторский отдел проводил ежедневную работу по поиску наиболее привлекательных проектов, основным направлением для инвестирования являлись объекты недвижимости. В процессе работы ИФ EMIVN заслужил высокую оценку инвесторов и, как следует, объёмы инвестиций возросли более чем в 10 раз. ИФ EMIVN разработал крепкий, работающий и масштабируемый инвестиционный механизм. Наша устойчивая и прочная операционная платформа, дисциплинированная мульти-факторная система по контролю над рисками позволяет качественно увеличить доходность для инвесторов фонда.")
...
func (t *Telegram) handlePreferencesBtn(ctx telebot.Context) error {
	...
	return ctx.Send("- Получение пассивного дохода держателями инвестиционного токена EMIVN не единственное преимущество. Фондом разработаны уникальные предложения для инвесторов, к которым относятся:\n\n- Возможность одними из первых пользоваться VR-игрой EMIVN RACE, аналогов которой нет в мире;\n\n- Возможность пользоваться продуктами EMIVN на специальных условиях;\n\n- Членство в бизнес-клубе EMIVN, участие в мероприятиях клуба;\n\n- Возможность приобретения брендированных ювелирных изделий с логотипом EMIVN;\n\n- Возможность покупки люксовых спорткаров у партнеров фонда EMIVN за токены EMIVN ниже рыночной стоимости до 20%;\n\n- Возможность приобретения объектов недвижимого имущества у партнеров фонда EMIVN за токены EMIVN ниже рыночной стоимости до 15%;\n\n- Возможность возведения объектов недвижимости разного класса за токены EMIVN на выгодных условиях.")
